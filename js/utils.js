...
export function calcCantidad(l) { return l.cantidad === '' || l.cantidad == null ? 1 : (parseFloat(l.cantidad) || 0); }
export function calcLineaTotal(l) { return calcCantidad(l) * (parseFloat(l.precioUnitario) || 0); }
